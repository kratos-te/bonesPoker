...
export const getTableData = async (program: anchor.Program) => {
...
export const createInitializeTx = async (admin: PublicKey, program: anchor.Program) => {
  ...
  tx.add(
    program.instruction.initialize(global_bump, escrow_bump, {
      accounts: {
        admin: admin,
        globalAuthority,
        escrowVault,
...
export const createUpdateAdminTx = async (
  ...
  tx.add(
    program.instruction.updateAdmin(global_bump, newAdmin, {
      accounts: {
        admin: admin,
        globalAuthority,
      },
...
export const createUpdateTreasuryTx = async (
  ...
  tx.add(
    program.instruction.updateTreasury(global_bump, newTreasury, {
      accounts: {
        admin: admin,
        globalAuthority,
      },
...
export const createUpdateBackendWalletTx = async (
  ...
  tx.add(
    program.instruction.updateBackend(global_bump, backend_wallet, {
      accounts: {
        admin: admin,
        globalAuthority,
      },
...
export const createAddTableTx = async (
  ...
  tx.add(
    program.instruction.addTable(
      global_bump,
      game_bump,
      new anchor.BN(stack),
      new anchor.BN(buy_in),
      new anchor.BN(blinds),
      new anchor.BN(max_seats),
      {
        accounts: {
          admin: admin,
          globalAuthority,
...
export const createRemoveTableTx = async (
  ...
  tx.add(
    program.instruction.removeTable(
      global_bump,
      game_bump,
      new anchor.BN(stack),
      new anchor.BN(buy_in),
...
export const createEnterTableTx = async (
  ...
  tx.add(
    program.instruction.enterTable(
      escrow_bump,
      game_bump,
      new anchor.BN(stack),
      new anchor.BN(buy_in),
...
export const createUserLeaveTableTx = async (
  ...
  tx.add(
    program.instruction.userLeaveTable(
      global_bump,
      escrow_bump,
      game_bump,
      new anchor.BN(stack),
...
export const createSendRewardTx = async (
  ...
  tx.add(
    program.instruction.sendReward(
      global_bump,
      escrow_bump,
      new anchor.BN(totalWinnedVault),
      new anchor.BN(leaveVault),
      {
        accounts: {
          owner,
          globalAuthority,
...
export const createAddTournamentTx = async (
  ...
  tx.add(
    program.instruction.addTournament(
      global_bump,
      tournament_bump,
      new anchor.BN(stack),
      new anchor.BN(buy_in),
...
export const createRemoveTournamentTx = async (
  ...
  tx.add(
    program.instruction.removeTournament(
      global_bump,
      tournament_bump,
      new anchor.BN(stack),
      new anchor.BN(buy_in),
...
export const createEnterTournamentTx = async (
  ...
  tx.add(
    program.instruction.enterTournament(
      escrow_bump,
      tournament_bump,
      new anchor.BN(stack),
      new anchor.BN(buy_in),
...
export const createUserLeaveTournamentTx = async (
  ...
  tx.add(
    program.instruction.userLeaveTournament(
      global_bump,
      escrow_bump,
      tournament_bump,
      new anchor.BN(stack),
