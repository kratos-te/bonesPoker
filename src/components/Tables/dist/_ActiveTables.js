...
var ActiveTables = function (_a) {
    var buyInFilter = _a.buyInFilter, setLoading = _a.setLoading, loading = _a.loading, afkGamelist = _a.afkGamelist;
    ...
    var handleRejoinGame = function (gameId) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            if (loading) {
                toastGroup_1.errorAlert("Currently joining a game");
                return [2 /*return*/];
            ...
            socket.emit("rejoinGameFromAfk", wallet.publicKey.toBase58(), gameId, function (_myPlayerId) { return __awaiter(void 0, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    if (_myPlayerId) {
                        ...
                        setLoading(false);
                        setSelectedGameId("");
                        toastGroup_1.errorAlert("Rejoining failed. Plz try again");
                    }
                    return [2 /*return*/];
                });
            }); });
    ...
    return (react_1["default"].createElement("div", { className: styles.container },
        react_1["default"].createElement("table", { className: styles.table },
            ...
            react_1["default"].createElement("tbody", { className: styles.tbody },
                afkGamelist == undefined &&
                    gamelist
                        .filter(function (game) {
                        if (buyInFilter && buyInFilter > 0)
                            return game.buyIn == buyInFilter;
                        else
                            return true;
                    })
                        .map(function (game, i) {
                        if (Number(game.count) != game.numSeats)
                            return (react_1["default"].createElement("tr", { key: "table-" + game.gameId },
                ...
                afkGamelist &&
                    afkGamelist.map(function (afkGame, index) {
                        return (react_1["default"].createElement("tr", { key: "afk-table-" + afkGame.gameId },
                            react_1["default"].createElement("td", null,
                                afkGame.buyIn / web3_js_1.LAMPORTS_PER_SOL,
                                " SOL \u00A0",
                                afkGame.name),
                            react_1["default"].createElement("td", null, afkGame.buyIn / web3_js_1.LAMPORTS_PER_SOL),
                            react_1["default"].createElement("td", null, "SOL"),
                            react_1["default"].createElement("td", null, afkGame.initialStack),
                            react_1["default"].createElement("td", null,
                                afkGame.minBet / 2,
                                " /",
                                afkGame.minBet),
                            react_1["default"].createElement("td", null,
                                ...
                                " /",
                                afkGame.numSeats),
                            react_1["default"].createElement("td", null, selectedGameId == afkGame.gameId && loading ? (react_1["default"].createElement("button", { className: styles.loadingBtn },
                                "rejoining table",
                                react_1["default"].createElement("div", { className: "lds-ellipsis" },
                                    react_1["default"].createElement("div", null),
                                    react_1["default"].createElement("div", null),
                                    react_1["default"].createElement("div", null),
                                    react_1["default"].createElement("div", null)))) : (react_1["default"].createElement("button", { className: styles.joinBtn, onClick: function () { return handleRejoinGame(afkGame.id); } }, "rejoin")))));
                    })))));
};
exports["default"] = ActiveTables;
