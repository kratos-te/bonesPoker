...
const styles = require("./SimpleTable.module.css");
...
const SimpleTable: FC<SimpleTableProps> = ({ setLoading, loading }) => {
  const {
    setMyPlayerId,
    setChat,
    ...
    <div className={styles.container}>
      <table className={styles.table}>
        ...
        <tbody className={styles.tbody}>
          {gamelist.slice(0, Math.min(5, gamelist.length)).map((game, i) => {
